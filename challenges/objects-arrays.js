...
console.log(`The tyrannosauru weighed ${dinosaurTyrannosaurus.weight}`);

// What was the diet of a velociraptor?
console.log(`The diet of a velociraptor was ${dinosaurVelociraptor.diet}`);

// How long was a stegosaurus?
console.log(`The length of a stegosaurus was ${dinosaurStegosaurus.length}`);

// What time period did tyrannosaurus live in?
console.log(`tyrannosaurus lived in the ${dinosaurTyrannosaurus.period} era` );


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(dinosaurTyrannosaurus.roar());
